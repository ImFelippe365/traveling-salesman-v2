...
class Graph:
    ...
    def get_best_path(self):
        arvore_prim = nx.minimum_spanning_tree(self.graph, algorithm='kruskal', weight='weight')
    ...
    def show_graph(self, path=None):
        ...
        secso = nx.minimum_spanning_tree(self.graph, algorithm='kruskal', weight='weight')
        nx.draw(secso, positions, with_labels=True, font_weight='bold', node_size=700, node_color='red', edge_color='red', width=2)
